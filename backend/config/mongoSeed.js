...
const systemTemplates = [
  {
    ...
    mapping_json: { template_type: 'NORMAL_TABLE', sheetName: '일반내역표', mappings: [], locked: true },
  },
  {
    ...
    mapping_json: { template_type: 'COMPARISON_MATRIX', sheetName: '비교표', mappings: [], locked: true },
  },
  {
    ...
    mapping_json: { template_type: 'WORK_LOG_TABLE', sheetName: '작업일보', mappings: [], locked: true },
  },
];

async function seedMongo() {
  const adminRoleId = await upsertBy(Role, 'roles', { role_code: 'SYSTEM_ADMIN' }, {
    role_code: 'SYSTEM_ADMIN', role_name: '시스템 관리자', description: '사용자 관리, 자사 양식 등록, 템플릿 매핑 관리 권한', active_yn: 'Y',
  });
