...
export function inferUserOutputIntent(text = '') {
...
export function isLayoutAllowedForIntent(layoutType = '', intent = 'AUTO', text = '') {
  const layout = String(layoutType || '').toUpperCase();
...
export function scoreLayoutAgainstText(layout, text = '', mainType = '', explicitIntent = 'AUTO') {
  const ctx = analyzeContext(text);
