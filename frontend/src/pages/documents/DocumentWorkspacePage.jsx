      ...
      <section className="rounded-[28px] border border-slate-200 bg-white/95 p-4 shadow-card backdrop-blur">
        <div className="flex flex-col gap-4 2xl:flex-row 2xl:items-center">
          ...
          <div className="grid flex-1 grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-[170px_210px_190px_minmax(220px,1fr)_120px_120px_120px]">
            ...
            <Select label="양식 배치" value={templateLayoutMode} onChange={setTemplateLayoutMode} disabled={outputMode !== 'COMPANY_TEMPLATE'} options={[{ value: 'COMPACT_VENDOR_GROUPS', label: '실제 업체만 표시' }, { value: 'PRESERVE_TEMPLATE', label: isProductPriceSurveyTemplate(selectedTemplate) ? '원본 5칸 유지' : '원본 3칸 유지' }]} />
